...
const ProvidingAnExtensionCordReportRu: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.ProvidingAnExtensionCord} language={'ru'} />
...
export default observer(ProvidingAnExtensionCordReportRu);
