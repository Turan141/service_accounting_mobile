...
const SanitaryInspectionReportEn: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.SanitaryInspection} language={'en'} />
...
export default observer(SanitaryInspectionReportEn);
