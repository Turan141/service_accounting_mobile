...
const DriverProvidingReportEn: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.DriverProviding} language={'en'} />
...
export default observer(DriverProvidingReportEn);
