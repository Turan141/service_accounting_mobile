...
const ProvisionOfProcessWaterReportRu: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.ProvisionOfProcessWater} language={'ru'} />
...
export default observer(ProvisionOfProcessWaterReportRu);
