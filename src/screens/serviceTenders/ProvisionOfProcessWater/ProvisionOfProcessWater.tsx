...
const ProvisionOfProcessWaterScreen: FC<TenderScreenProps> = ({ navigation }) => {
  ...
  const stepperSteps: TaskStepSchema[] = useMemo(
    () => [
      ...
      {
        order: 2,
        label: 'Предоставление технической воды для мойки двигателей, колес, агрегатов',
          ...
          <View style={{ padding: 20 }}>
            ...
            {errors.forcedDownTime ? (
              <InlineAlert type="danger">
                Чтобы начать "Предоставление технической воды для мойки двигателей, колес, агрегатов", сначала отожмите
                кнопку «Вынужденный простой»
              </InlineAlert>
            ) : null}
