...
const ProvidingAirLunchDeviceReportRu: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.ProvidingAirLaunchDevice} language={'ru'} />
...
export default observer(ProvidingAirLunchDeviceReportRu);
