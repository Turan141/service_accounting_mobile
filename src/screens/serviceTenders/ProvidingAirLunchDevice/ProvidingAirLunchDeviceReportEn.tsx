...
const ProvidingAirLunchDeviceReportEn: FC = () => {
  ...
  return (
    <View>
      ...
      <MonoServiceExecutionTime itemType={DocumentItemNamesEnum.ProvidingAirLaunchDevice} language={'en'} />
...
export default observer(ProvidingAirLunchDeviceReportEn);
