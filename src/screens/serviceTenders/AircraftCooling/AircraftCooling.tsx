...
import AircraftCoolingReport from './AircraftCoolingReport';
...
interface AircraftCoolingFormValues {
  ...
  [DocumentItemNamesEnum.AircraftCooling]: DocumentItemView;
...
const AircraftCoolingScreen: FC<TenderScreenProps> = ({ navigation }) => {
  ...
  const tenderItemName = DocumentItemNamesEnum.AircraftCooling;
  ...
  return (
    <>
      ...
      >
        ...
        {currentStep === TenderStepperKeys.Result && <AircraftCoolingReport />}
      </ScrollViewContainer>
    </>
  );
};

export default observer(AircraftCoolingScreen);
